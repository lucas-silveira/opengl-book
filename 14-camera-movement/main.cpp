...
void mouseCallback(GLFWwindow* window, double xpos, double ypos)
{
    ...
    float sensitivity = 0.1f; // avoid strong movements
    xoffset *= sensitivity;
    yoffset *= sensitivity;
...
{
    fov = glm::clamp(fov-(float)yoffset, 1.f, 45.f);
}
...
void processInput(GLFWwindow* window)
{
    ...
    float cameraSpeed = 2.5f * deltaTime; // garantindo que a velocidade seja de 2.5 por segundo
